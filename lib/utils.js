...
export function set(obj, paramName, value) {
    if(!isObject(obj)) {
    ...
    const params = isArray(paramName) ? paramName : paramName.split('.');
    const param = params.slice(0,1)[0];
